    ...
    const data = [
      {
        ...
        "providerIds": ["0x168b1502b047d7e77f83da38e99b1a4081feedce79cc27d4e9c19a15ebf9a6ea", "0x50581dae10313e3460821fe0d9f4a3929c25a82a88974e6ec28af8b901683b3a"]
      },
      {
        "name": "Sybil Prevention",
        "desc": "I need to ensure my community or app is not attacked.",
        "providerIds": ["0x9cb483e777bd2e7f27a4cc16bca39448c7bda743c53794a8116d6141e8e090eb", "0x50581dae10313e3460821fe0d9f4a3929c25a82a88974e6ec28af8b901683b3a"]
      },
      {
        "name": "Bot prevention",
        "desc": "I want my community or app to be safe from bots",
        "providerIds": ["0xe9f29c68c836590e76b8219ef1d1722b806f1c5beeb25954c8053ab1e6974a6a", "0x50581dae10313e3460821fe0d9f4a3929c25a82a88974e6ec28af8b901683b3a"]
      },
      {
        "name": "Customizable",
    ...
    const data = [
      {
        ...
        "providerIds": ["0x168b1502b047d7e77f83da38e99b1a4081feedce79cc27d4e9c19a15ebf9a6ea", "0x50581dae10313e3460821fe0d9f4a3929c25a82a88974e6ec28af8b901683b3a"],
        "apiKey": "0x168b1502b047d7e77f83da38e99b1a4081feedce79cc27d4e9c19a15ebf9a6ea"
      },
      {
        "name": "secure facebook.com",
        "desc": "this api will be using for facebook.com.",
        "providerIds": ["0x168b1502b047d7e77f83da38e99b1a4081feedce79cc27d4e9c19a15ebf9a6ea", "0x50581dae10313e3460821fe0d9f4a3929c25a82a88974e6ec28af8b901683b3a"],
        "apiKey": "0x50581dae10313e3460821fe0d9f4a3929c25a82a88974e6ec28af8b901683b3a"
      },
    ];
    data.forEach((item) => {
