...
export const SUI_PROVIDER_CONFIG = {
  ...
  SUI_PROVIDER_OWNER: process.env.SUI_PROVIDER_OWNER,
  SUI_PROVIDER_CAP: process.env.SUI_PROVIDER_CAP,
  SUI_PROVIDER_PROVIDER_ID: process.env.SUI_PROVIDER_PROVIDER_ID,
} as const;
